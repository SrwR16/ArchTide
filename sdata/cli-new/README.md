...
| **Quick Actions** | `nandoroid quickactions` | Toggle Quick Actions HUD |
...
| **QR Code Scan** | `nandoroid region qrcode` | Scan QR code from selected region |
...
| Feature | Command | Description |
| :--- | :--- | :--- |
| **Wallpaper** | `nandoroid wallpaper [desktop\|lock]` | Open the wallpaper selection panel |
...
| **Pomodoro** | `nandoroid pomodoro {start\|pause\|stop\|reset}` | Control the Pomodoro timer |
| **Brightness** | `nandoroid brightness {up\|down}` | Adjust screen brightness |
