...
remove_deprecated_dependencies(){
  ...
  local list=()
  list+=(archtide-{microtex,pymyc-aur,oneui4-icons-git})
...
metapkgs=(./sdata/dist-arch/archtide-{audio,backlight,basic,fonts-themes,kde,portal,python,screencapture,toolkit,widgets})
metapkgs+=(./sdata/dist-arch/archtide-hyprland)
metapkgs+=(./sdata/dist-arch/archtide-microtex-git)
metapkgs+=(./sdata/dist-arch/archtide-quickshell-git)
metapkgs+=(./sdata/dist-arch/archtide-bibata-modern-classic-bin)
