...
remove_deprecated_dependencies(){
  ...
  local list=()
  list+=(flow-{microtex,pymyc-aur,oneui4-icons-git})
...
metapkgs=(./sdata/dist-arch/flow-{audio,backlight,basic,fonts-themes,kde,portal,python,screencapture,toolkit,widgets})
metapkgs+=(./sdata/dist-arch/flow-hyprland)
metapkgs+=(./sdata/dist-arch/flow-microtex-git)
metapkgs+=(./sdata/dist-arch/flow-quickshell-git)
metapkgs+=(./sdata/dist-arch/flow-bibata-modern-classic-bin)
