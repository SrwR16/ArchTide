...
Rectangle {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            StyledText {
                id: statusText
                text: (Config.ready && Config.options.appearance && Config.options.appearance.systemMonitor && Config.options.appearance.systemMonitor.showOnDesktop) ? I18nService.tr("Enabled") : I18nService.tr("Disabled")
