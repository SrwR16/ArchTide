...
Scope {
    ...
    PanelLoader { extraCondition: Config.options.sidebar.enableLeft; component: SidebarPolicies {} }
    PanelLoader { extraCondition: Config.options.sidebar.enableRight; component: SidebarDashboard {} }
