 ...
 * The stupid part is that when we run the shell from the terminal "qs -c flow", everything works perfectly fine without the need of "bash -lc" or setting the PATH. 
