...
Singleton {
    ...
    readonly property string cacheDir: Directories.home.replace("file://", "") + "/.cache/flow"
    ...
    readonly property string screenshotPath: "/tmp/flow_live_wp.png"
...
print(json.dumps(wallpapers))
    ...
    function updatePauseState() {
        ...
        const shellClasses = ["Quickshell", "flow-settings", "flow-monitor", "wayland-dashboard", "waybar", "ags", "fuzzel", "linux-wallpaperengine"];
