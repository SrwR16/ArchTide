...
# FLOW Screen Recorder
# Ported from 'ii' with adjustments for flow paths

CONFIG_FILE="$HOME/.config/quickshell/flow/config.json"
STATE_FILE="${HOME}/.local/state/quickshell/flow_states.json"
