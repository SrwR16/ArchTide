...
Item {
    ...
    readonly property string storagePath: Functions.FileUtils.trimFileProtocol(Directories.home) + "/.cache/flow/todo.json"
    readonly property string oldStoragePath: Functions.FileUtils.trimFileProtocol(Directories.home) + "/.cache/flow/notes.json"
