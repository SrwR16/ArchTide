...
ColumnLayout {
    ...
    readonly property var allIpcItems: [
        { name: "Toggle App Launcher", target: "launcher", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call launcher toggle" },
        { name: "Toggle Spotlight Search", target: "spotlight", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call spotlight toggle" },
        { name: "Toggle Notification Center", target: "notifications", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call notifications toggle" },
        { name: "Toggle Quick Settings", target: "quicksettings", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call quicksettings toggle" },
        { name: "Toggle System Monitor", target: "systemmonitor", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call systemmonitor toggle" },
        { name: "Toggle Workspace Overview", target: "overview", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call overview toggle" },
        { name: "Toggle Session Menu", target: "session", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call session toggle" },
        { name: "Toggle Dashboard", target: "dashboard", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call dashboard toggle" },
        { name: "Toggle Quick Actions", target: "quickactions", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call quickactions toggle" },
        { name: "Toggle Settings Window", target: "settings", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call settings toggle" },
        { name: "Toggle Wallpaper Selector", target: "wallpaper", method: "toggle", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call wallpaper toggle" },
        { name: "Select Desktop Wallpaper", target: "wallpaper", method: "openDesktop", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call wallpaper openDesktop" },
        { name: "Select Lockscreen Wallpaper", target: "wallpaper", method: "openLock", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call wallpaper openLock" },
        { name: "Lock Screen", target: "lock", method: "lock", category: "Sidebar & Panels", cmd: "quickshell -c flow ipc call lock lock" },

        { name: "Take Region Screenshot", target: "region", method: "screenshot", category: "Region Tools", cmd: "quickshell -c flow ipc call region screenshot" },
        { name: "Google Lens Region Search", target: "region", method: "search", category: "Region Tools", cmd: "quickshell -c flow ipc call region search" },
        { name: "OCR Screen Text", target: "region", method: "ocr", category: "Region Tools", cmd: "quickshell -c flow ipc call region ocr" },
        { name: "Scan Region QR Code", target: "region", method: "qrcode", category: "Region Tools", cmd: "quickshell -c flow ipc call region qrcode" },
        { name: "Record Selected Region", target: "region", method: "record", category: "Region Tools", cmd: "quickshell -c flow ipc call region record" },
        { name: "Record Region + Audio", target: "region", method: "recordWithSound", category: "Region Tools", cmd: "quickshell -c flow ipc call region recordWithSound" },
        { name: "Record Fullscreen + Audio", target: "region", method: "recordFullscreenWithSound", category: "Region Tools", cmd: "quickshell -c flow ipc call region recordFullscreenWithSound" },

        { name: "Increase Display Brightness", target: "brightness", method: "increase", category: "Media & System", cmd: "quickshell -c flow ipc call brightness increase" },
        { name: "Decrease Display Brightness", target: "brightness", method: "decrease", category: "Media & System", cmd: "quickshell -c flow ipc call brightness decrease" },
        { name: "Toggle Pomodoro Timer", target: "pomodoro", method: "toggle", category: "Media & System", cmd: "quickshell -c flow ipc call pomodoro toggle" },
        { name: "Select Wallpaper Accent Color", target: "wallpaper", method: "pickAccent", category: "Media & System", cmd: "quickshell -c flow ipc call wallpaper pickAccent" }
    ]
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            StyledText {
                text: 'hl.bind("SUPER + I", hl.dsp.exec_cmd("quickshell -c flow ipc call settings toggle"))'
        ...
        delegate: Rectangle {
            ...
            RowLayout {
                ...
                RippleButton {
                    ...
                    onClicked: {
                        Quickshell.execDetached(["quickshell", "-c", "flow", "ipc", "call", modelData.target, modelData.method]);
                    }
