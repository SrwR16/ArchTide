            ...
            delegate: Rectangle {
                ...
                RowLayout {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            text: (modelData.command === "dgop" || modelData.command === "/usr/bin/dgop" || (modelData.command && modelData.command.includes("dgop"))) ? "flow-monitor" : modelData.command
                            Layout.fillWidth: true
                ...
                MouseArea {
                    ...
                    onClicked: (mouse) => {
                        if (mouse.button === Qt.RightButton) {
                            const displayName = (modelData.command === "dgop" || modelData.command === "/usr/bin/dgop" || (modelData.command && modelData.command.includes("dgop"))) ? "flow-monitor" : modelData.command;
