    ...
    ColumnLayout {  
        ...
        RowLayout { // Header  
            ...
            StyledText {  
                ...
                text: root.responseData.provider === "system" ? "System" :   
                      root.responseData.provider === "unsplash" ? "Unsplash" : "Wallhaven"  
            }
            }  
        ...
        Repeater {  
            model: ScriptModel {  
                values: {  
                    if (!root.responseData.images || root.responseData.images.length === 0) {  
                        return [];  
                    }  
