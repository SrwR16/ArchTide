...
MouseArea {
    ...
    Loader {
        id: popupLoader
        source: Config.options.bar.bluetoothDevicesLayout === "expressive" ? "../bar/popups/bluetooth/ExpressiveBluetoothDevicesPopup.qml" : "../bar/popups/bluetooth/BluetoothDevicesPopup.qml"
        onLoaded: {
