...
import Quickshell
import qs.modules.flow.bar.widgets.weather
import qs.modules.flow.bar.shared
import qs.modules.flow.bar.registry
import qs.modules.flow.bar.groups

// Widget subdir imports (bar/widgets/<group>/)
import qs.modules.flow.bar.widgets.workspaces
import qs.modules.flow.bar.widgets.clock
import qs.modules.flow.bar.widgets.media
import qs.modules.flow.bar.widgets.battery
import qs.modules.flow.bar.widgets.bluetooth
import qs.modules.flow.bar.widgets.resources
import qs.modules.flow.bar.widgets.keyboard
import qs.modules.flow.bar.widgets.tray
import qs.modules.flow.bar.widgets.sports
import qs.modules.flow.bar.widgets.activeWindow
import qs.modules.flow.bar.widgets.dashboard
import qs.modules.flow.bar.widgets.power
import qs.modules.flow.bar.widgets.utilButtons
import qs.modules.flow.bar.widgets.policies
import qs.modules.flow.bar.widgets.timer
import qs.modules.flow.bar.widgets.indicators
import qs.modules.flow.bar.widgets.dockToPanel

import qs.modules.flow.verticalBar as Vertical
