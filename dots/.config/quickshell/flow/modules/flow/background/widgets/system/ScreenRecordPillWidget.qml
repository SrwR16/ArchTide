...
AbstractBackgroundWidget {
    ...
    // State from Persistent screenRecord state
    readonly property bool isActive: Persistent.states.screenRecord.active
    ...
    configEntryName: "screen_record_pill"
    implicitWidth: 240
    implicitHeight: 120
    ...
    Rectangle {
        ...
        RippleButton {
            ...
            MaterialSymbol {
                ...
                text: root.isActive ? "stop" : "videocam"
                iconSize: 38
        ...
        StyledText {
            ...
            anchors.verticalCenter: parent.verticalCenter
            text: root.isActive ? Translation.tr("Recording") : Translation.tr("Record")
            font.pixelSize: 24
