...
Singleton {
    ...
    readonly property var enumConstraints: ({
            ...
            "appearance.colorEngine": ["archtide", "fork"],
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property string panelFamily: "archtide" // "archtide", "waffle"
            ...
            property JsonObject appearance: JsonObject {
                ...
                property string colorEngine: "archtide" // "archtide" | "fork" — color generation engine
            ...
            property JsonObject update: JsonObject {
                ...
                // to setup-archtide.sh). See AboutConfig.qml.
