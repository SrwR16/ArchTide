...
Singleton {
    ...
    readonly property string cliPath: FileUtils.trimFileProtocol(`${Directories.home}/.local/bin/archtide`)

    // Config paths

    property string generalConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/GeneralConfig.qml`)
    property string barConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/BarConfig.qml`)
    property string backgroundConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/BackgroundConfig.qml`)
    property string interfaceConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/InterfaceConfig.qml`)
    property string hyprlandConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/HyprlandConfig.qml`)
    property string servicesConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/ServicesConfig.qml`)
    property string advancedConfigPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/modules/settings/AdvancedConfig.qml`)
    ...
    property string shellConfig: FileUtils.trimFileProtocol(`${Directories.config}/archtide`)
    property string shellConfigName: "config.json"
    property string shellConfigPath: `${Directories.shellConfig}/${Directities.shellConfigName}`
    ...
    property string gammaControlScriptPath: FileUtils.trimFileProtocol(`${Directories.scriptPath}/brightness/archtide-gamma-control`)
    ...
    property string wallpaperSwitchScriptPath: FileUtils.trimFileProtocol(
        `${Directories.scriptPath}/colors/${(Config.options.appearance.colorEngine ?? "archtide") === "fork" ? "switchwall" : "switchwall_archtide"}.sh`
    )
    ...
    // Widget extensions
    property string userWidgetsPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/user_widgets`)
    property string widgetExtensionsPath: `${Directories.shellConfig}/widget_extensions.json`
    property string widgetBackupsPath: FileUtils.trimFileProtocol(`${Directories.config}/quickshell/archtide/user_widgets/.backups`)
